...
function clik (btn){
  btn.textContent == "Iya 🤗" ? img.src = "patahHati.gif" : img.src = "jempol.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "250px"
  ctn.style.width = "270px"
  return btn.textContent == "Iya 🤗" ? kata.textContent = "gacorrrrrr" : kata.textContent = "semangat cuy, kata nya mau S.T"
